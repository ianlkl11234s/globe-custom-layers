...
- [3.4 GLSL gotchas](glsl-gotchas.md) — more silent failures in the same rendering path
- [2.2 Instanced tracks](../02-scaling-up/instanced-tracks.md) — the multi-layer instancing pattern `renderOrder` is composing here
