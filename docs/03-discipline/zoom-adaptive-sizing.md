...
- [3.2 Depth and blending](depth-and-blending.md) — once size is under control, draw order is the next thing you own
- [2.3 Vector field particles](../02-scaling-up/vector-field-particles.md) — the density side of this problem, at scale
