...
- [3.1 Batched trails](batched-trails.md) — the mirror image: what to cache when geometry *is* mostly static
- [4.1 Zoom-adaptive sizing](../04-discipline/zoom-adaptive-sizing.md) — the same quantization discipline applied to on-screen size instead of particle count
- [4.3 Sharing a WebGL context](../04-discipline/shared-gl-context.md) — VAO and GL-state discipline on a context you don't own
