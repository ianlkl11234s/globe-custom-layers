...
- [3.1 Batched trails](batched-trails.md) — the same fixed-capacity, cull-before-upload discipline applied to line geometry instead of instances
- [4.1 Zoom-adaptive sizing](../04-discipline/zoom-adaptive-sizing.md) — the screen-space scale formula used for instance size
- [4.3 Sharing a WebGL context](../04-discipline/shared-gl-context.md) — restoring GL state a Three renderer leaves behind on a shared context
