# 3.4 Finding the actual bottleneck

> **Status:** 📋 Reported — a narrative account of one production incident. There is nothing to reproduce as a standalone example; the fix it describes is the min-heap eviction covered in [3.1](batched-trails.md).
...
- [3.1 Batched trails](batched-trails.md) — the fix this case study measures
- [3.2 Instanced tracks](instanced-tracks.md) — the second wrong guess, and why a real 42% win didn't matter
